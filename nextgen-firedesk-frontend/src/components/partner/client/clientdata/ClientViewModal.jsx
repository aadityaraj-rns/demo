...
import { dialogTitleStyles } from "../../../../utils/helpers/customDialogTitleStyle.js";
      ...
      >
        ...
        <DialogContent>
          <Grid container columnSpacing={3}>
            ...
            <Grid item xs={12} md={6} lg={6}>
              <ViewTextInput label="Type" value={client.clientType} />
            </Grid>
            <Grid item xs={12} md={6} lg={6}>
              <ViewTextInput label="Name" value={client.name} />
            </Grid>
            <Grid item xs={12} md={6} lg={6}>
              <ViewTextInput label="Category" value={client.categoryNames} />
            </Grid>
            <Grid item xs={12} md={6} lg={6}>
              <ViewTextInput label="Industry" value={client.industryName} />
            </Grid>
            <Grid item xs={12} md={6} lg={6}>
