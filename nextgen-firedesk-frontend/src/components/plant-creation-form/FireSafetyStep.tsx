          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input 
                ...
                onChange={(e) => handleChange('primeOverTankCapacity', e.target.value)}
              />
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input 
                ...
                onChange={(e) => handleChange('terraceTankCapacity', e.target.value)}
              />
              <div className="flex items-center px-3 bg-muted rounded-md text-sm text-muted-foreground">
                Liters
              </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input 
                ...
                onChange={(e) => handleChange('headerPressureBar', e.target.value)}
              />
              <div className="flex items-center px-3 bg-muted rounded-md text-sm text-muted-foreground">
                Bar
              </div>
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              onChange={(e) => handleChange('systemCommissionDate', e.target.value)}
            />
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-6">
          <div className="space-y-2">
            ...
            <Input 
              id="amcVendor" 
              placeholder="e.g., FireTech Services"
              value={formData.amcVendor || ''}
              onChange={(e) => handleChange('amcVendor', e.target.value)}
            />
          </div>
          <div className="space-y-2">
        ...
        <div className="grid grid-cols-4 gap-6">
          <div className="space-y-2">
            ...
            <Input 
              ...
              onChange={(e) => handleChange('numFireExtinguishers', e.target.value)}
            />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              onChange={(e) => handleChange('numSafeAssemblyAreas', e.target.value)}
            />
          </div>
        </div>
      </div>
