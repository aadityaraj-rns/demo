...
const AddPlant = ({ onPlantAdded }) => {
  ...
  const plantFormSchema = Yup.object().shape({
    ...
    plantImage: Yup.mixed().nullable().optional(),
  ...
  return (
    <>
      <Button color="warning" size="small" variant="contained" onClick={toggle}>
            ...
            <Grid spacing={3} container mt>
              ...
              <Grid item xs={12} lg={6}>
                <TextField
                  ...
                  error={
                    formik.touched.plantImage &&
                    Boolean(formik.errors.plantImage)
                  }
                  helperText={
                    formik.touched.plantImage && formik.errors.plantImage
                  }
                  InputLabelProps={{ shrink: true }}
                />
                {formik.values.plantImage && (
