...
import {
  ...
  getRefillTestOverview,
} from "../../../../api/organization/internal";
import PropTypes from "prop-types";

const RefillStatusSummary = ({ plantId, categoryId }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (selectedDateRange && selectedBuilding) {
        const response = await getRefillTestOverview({
          selectedBuilding,
          selectedDateRange,
          plantId,
          categoryId,
...
RefillStatusSummary.propTypes = {
  plantId: PropTypes.any,
  categoryId: PropTypes.any,
};
export default RefillStatusSummary;
