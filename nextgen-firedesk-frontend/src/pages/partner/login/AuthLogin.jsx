...
import { partnerLogin } from "../../../api/partner/internal";
    ...
    onSubmit: async (values) => {
      ...
      if (response.status == 200) {
        const partner = {
          ...
          loginID: response.data.partner.loginID,
  ...
  return (
    <>
      <form onSubmit={formik.handleSubmit}>
        <Stack spacing={2}>
          {" "}
          {/* Use spacing for Stack to control vertical gaps */}
          <Box px={10}>
            <CustomTextField
              color="secondary"
              id="loginID"
            ...
            >
              ...
              <Typography
                component={Link}
                // to="/forgot-password"
                to={`/partner/forgot-password?loginID=${formik.values.loginID}`}
                fontWeight="500"
