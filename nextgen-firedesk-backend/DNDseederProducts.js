    ...
    const products = [
      ...
      },
      {
        ...
        variants: [
          ...
          {
            type: "AFFF-AR",
            subType: ["Portable", "Trolley", "Modular", "Cartridge"],
            description:
              "Alcohol-Resistant Aqueous Film-Forming Foam (AFFF-AR) extinguisher, effective on flammable liquid fires including polar solvents and hydrocarbons.",
            image: "https://example.com/images/afff-foam.png",
          },
          {
            type: "Foam",
      ...
      },
      {
        ...
        variants: [
          ...
          {
            type: "HFC 236",
            subType: ["Modular", "Cartridge", "Portable", "Trolley"],
            description: "Clean agent extinguisher with HFC-236fa.",
            image: "https://example.com/images/hfc-236fa.png",
          },
          {
      ...
      {
        categoryId: extinguishersCategory._id,
        productName: "Water Mist",
        testFrequency: "One Year",
        variants: [
          {
            type: "Water",
            subType: ["Trolley", "Portable", "Modular", "Cartridge"],
            description: "Water extinguisher for Class A fires.",
            image: "https://example.com/images/water.png",
          },
        ],
