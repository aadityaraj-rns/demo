...
class AccountLoggedInDialog extends StatefulWidget {
  const AccountLoggedInDialog({super.key});
  @override
  State<AccountLoggedInDialog> createState() => _AccountLoggedInDialogState();
}

class _AccountLoggedInDialogState extends State<AccountLoggedInDialog> {
  @override
          ...
          children: [
            ...
            Expanded(
              child: Container(
                ...
                child: Image.asset("assets/images/login_success.png",
                    width: 104.h, height: 104.h),
              ),
            ),
            getVerSpace(31.h),
            loginHeader("Account LoggedIn",
