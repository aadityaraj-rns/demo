...
class TableForSubmittedData extends StatefulWidget {
  ...
  @override
  State<TableForSubmittedData> createState() => _TableForSubmittedDataState();
}

class _TableForSubmittedDataState extends State<TableForSubmittedData> {
  ...
  Widget build(BuildContext context) {
    print("description list data i got is ${widget.descriptionList}");
    ...
    return getDefaultTextFiledWithLabelAndBorder(
      ...
      onChanged: (value) {
        ...
        provider.updateQuestionNote(
          widget.index,
          widget.descriptionList[index].toString(),
          value,
        );
      },
      context,
