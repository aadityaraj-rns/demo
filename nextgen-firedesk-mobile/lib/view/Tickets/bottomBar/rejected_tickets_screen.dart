...
class RejectedTicketsScreen extends StatelessWidget {
  final String plantId;
  const RejectedTicketsScreen({super.key, required this.plantId});
    ...
    switch (allTicketsProvider.dataStatus) {
      ...
      case Status.ERROR:
        if (allTicketsProvider.dataError == InternetException) {
          return InterNetExceptionWidget(
            onPress: () {
              allTicketsProvider.fetchTicketsByStatus(context, 4, plantId);
            },
          );
      ...
      case Status.COMPLETED:
        return buildTicketsTab(
          ...
          Icons.swipe_right,
          Colors.blue,
          allTicketsProvider.rejectedTicketsList,
        );
      default:
        return Center(
          child: CircularProgressIndicator(
