...
class ApprovalPendingTicketsScreen extends StatelessWidget {
  final String plantId;
  const ApprovalPendingTicketsScreen({super.key, required this.plantId});
    ...
    switch (allTicketsProvider.dataStatus) {
      ...
      case Status.ERROR:
        if (allTicketsProvider.dataError == InternetException) {
          return InterNetExceptionWidget(
            onPress: () {
              allTicketsProvider.fetchTicketsByStatus(context, 2, plantId);
            },
          );
      ...
      case Status.COMPLETED:
        return buildTicketsTab(
          ...
          Colors.blue,
          allTicketsProvider.appprovalPendingTicketsList,
        );
      default:
        return Center(
          child: CircularProgressIndicator(
