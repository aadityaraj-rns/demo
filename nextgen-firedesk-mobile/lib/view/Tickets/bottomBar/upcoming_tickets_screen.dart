...
class OpenTicketsScreen extends StatelessWidget{
  ...
  const OpenTicketsScreen({super.key, required this.plantId});
    ...
    switch (allTicketsProvider.dataStatus) {
      ...
      case Status.ERROR:
        if (allTicketsProvider.dataError == InternetException){
          return InterNetExceptionWidget(
            onPress: () {
              allTicketsProvider.fetchTicketsByStatus(context, 1, plantId);
            },
          );
      ...
      case Status.COMPLETED:
        return buildTicketsTab(
          ...
          Icons.check_circle,
          Colors.green,
          allTicketsProvider.upcomingTicketsList,
        );
      default:
        return Center(
          child: CircularProgressIndicator(
